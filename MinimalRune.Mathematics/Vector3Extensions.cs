...
namespace MinimalRune.Mathematics.Algebra
{
    public static class Vector3Extensions
    {
        ...
        public static Vector3 FromComponents(float[] components)
        {
            return new Vector3(
                components[0],
                components[1],
        ...
        /// </exception>
        [SuppressMessage("Microsoft.Design", "CA1062:Validate arguments of public methods")]
        public static Vector3 FromComponents(IList<float> components)
        {
            return new Vector3(
                components[0],
                components[1],
        ...
        /// </returns>
        [SuppressMessage("Microsoft.Usage", "CA2225:OperatorOverloadsHaveNamedAlternates")]
        public static bool GreaterThanOrEqualTo(Vector3 vector1, Vector3 vector2)
        {
            return vector1.X >= vector2.X
                   && vector1.Y >= vector2.Y
                   && vector1.Z >= vector2.Z;
        ...
        /// </returns>
        [SuppressMessage("Microsoft.Usage", "CA2225:OperatorOverloadsHaveNamedAlternates")]
        public static bool LessThan(Vector3 vector1, Vector3 vector2)
        {
            return vector1.X < vector2.X
                   && vector1.Y < vector2.Y
                   && vector1.Z < vector2.Z;
        ...
        /// </returns>
        [SuppressMessage("Microsoft.Usage", "CA2225:OperatorOverloadsHaveNamedAlternates")]
        public static bool LessThanOrEqualTo(Vector3 vector1, Vector3 vector2)
        {
            return vector1.X <= vector2.X
                   && vector1.Y <= vector2.Y
                   && vector1.Z <= vector2.Z;
        ...
        {
            if (!vector1.TryNormalize(out var result) || !vector2.TryNormalize(out var result2))

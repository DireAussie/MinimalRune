...
The red objects show the first time of impact.",
  ...
  public class ContinuousCollisionDetectionSample : BasicSample
  {
      ...
      : base(game)
    {
      ...
      _startPoseA = new Pose(new Vector3(0, 2, 0), Matrix.CreateRotationZ(0.1f));
      ...
      _targetPoseA = new Pose(new Vector3(0, -2, 0), Matrix.CreateRotationZ(0.63f));

      // Create a geometric object with a composite shape.
      // Position it on the left with an arbitrary rotation.
      _startPoseB = new Pose(new Vector3(-3, -1, 0), Matrix.CreateRotationZ(0.2f));
      ...
      _targetPoseB = new Pose(new Vector3(3, -1, 0), Matrix.CreateRotationZ(0.3f));

  ...
  public class ConstraintSample2 : PhysicsSample
  {
      ...
      : base(game)
    {
      ...
      PointOnLineConstraint pointOnLineConstraint = new PointOnLineConstraint
      {
        ...
        BodyB = sphere0,
        AnchorPositionBLocal = new Vector3(0, 0.5f, 0),
        // The line axis:
        AxisALocal = Vector3.UnitZ,
      ...
      PointOnPlaneConstraint pointOnPlaneConstraint = new PointOnPlaneConstraint
      {
        ...
        XAxisALocal = Vector3.UnitX,
        YAxisALocal = Vector3.UnitZ,
      ...
      {
        Pose = new Pose(new Vector3(4, 3, 0), Matrix.CreateRotationZ(ConstantsF.Pi)),
        MotionType = MotionType.Static,
      };
      Simulation.RigidBodies.Add(cone0);
      RigidBody cone1 = new RigidBody(new ConeShape(0.5f, 1f))
      {
        Pose = new Pose(new Vector3(4, 0, 0))
      };
      ...
      DistanceLimit distanceLimit = new DistanceLimit
      {
        ...
        AnchorPositionALocal = new Vector3(0, 1, 0),
        AnchorPositionBLocal = new Vector3(0, 1, 0),

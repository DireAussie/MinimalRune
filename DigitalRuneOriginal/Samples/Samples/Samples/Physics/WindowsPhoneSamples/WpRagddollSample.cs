...
namespace Samples.Physics
{
  ...
  public class WpRagdollSample : BasicSample
  {
    ...
    private void InitializePhysics()
    {
      ...
      var leftPlane = new RigidBody(new PlaneShape(Matrix.CreateRotationZ(MathHelper.ToRadians(-22f)) * Vector3.UnitX, -4.8f))
      {
        Name = "LeftPlane",
        MotionType = MotionType.Static,
      };
      ...
      var rightPlane = new RigidBody(new PlaneShape(Matrix.CreateRotationZ(MathHelper.ToRadians(22f)) * -Vector3.UnitX, -4.8f))
      {
        Name = "RightPlane",
        MotionType = MotionType.Static,
      };
      ...
      var topPlane = new RigidBody(new PlaneShape(Matrix.CreateRotationX(MathHelper.ToRadians(14f)) * Vector3.UnitZ, -3f))
      {
        Name = "TopPlane",
        MotionType = MotionType.Static,
      };
      ...
      var bottomPlane = new RigidBody(new PlaneShape(Matrix.CreateRotationX(MathHelper.ToRadians(-14f)) * -Vector3.UnitZ, -3f))
      {
        Name = "BottomPlane",
        MotionType = MotionType.Static,
      };
    ...
    public void AddRagdoll(float scale, Vector3 ragdollPosition)
    {
      ...
      {
        Pose = new Pose(new Vector3(-0.32f * scale, 0.06f * scale, -0.53f * scale) + ragdollPosition, Matrix.CreateRotationZ(ConstantsF.PiOver2)),
      };
      ...
      {
        Pose = new Pose(new Vector3(-0.62f * scale, 0.06f * scale, -0.53f * scale) + ragdollPosition, Matrix.CreateRotationZ(ConstantsF.PiOver2)),
      };
      ...
      {
        Pose = new Pose(new Vector3(-0.10f * scale, 0.01f * scale, 0.233f * scale) + ragdollPosition, Matrix.CreateRotationX(ConstantsF.PiOver2)),
      };
      ...
      {
        Pose = new Pose(new Vector3(-0.11f * scale, 0.01f * scale, 0.7f * scale) + ragdollPosition, Matrix.CreateRotationX(ConstantsF.PiOver2)),
      };
      ...
      Matrix leftShoulderJointOrientation = new Matrix();
      ...
      Matrix rightShoulderJointOrientation = new Matrix();
      ...
      Matrix elbowAxisOrientation = new Matrix(0, 0, -1,
        0, 1, 0,
        1, 0, 0);

      ...
      : base(game)
    {
      ...
      _prismaticJoint = new PrismaticJoint
      {
        ...
        AnchorPoseALocal = new Pose(new Vector3(0, 0, 0), new Matrix(0, 1, 0,
                                                                        -1, 0, 0,
                                                                         0, 0, 1)),
        AnchorPoseBLocal = new Pose(new Vector3(0, 0, 0), new Matrix(0, 1, 0,
                                                                        -1, 0, 0,
                                                                         0, 0, 1)),
        CollisionEnabled = false,
      };
      ...
      _twistSwingLimit = new TwistSwingLimit
      {
        ...
        AnchorOrientationALocal = new Matrix(0, 1, 0,
                                               -1, 0, 0,
                                                0, 0, 1),
        BodyB = cylinder0,
        AnchorOrientationBLocal = new Matrix(0, 1, 0,
                                               -1, 0, 0,
                                                0, 0, 1),
        CollisionEnabled = false,
      ...
      QuaternionMotor quaternionMotor = new QuaternionMotor
      {
        ...
        // orientation.
        TargetOrientation = Quaternion.CreateRotationZ(MathHelper.ToRadians(30)),

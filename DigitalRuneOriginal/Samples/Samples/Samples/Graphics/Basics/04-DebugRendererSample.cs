...
text, points, lines, arrows, bounding boxes, geometric objects, ...",
  ...
  public class DebugRendererSample : Sample
  {
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      _debugRenderer.DrawModel(_xnaModel, new Pose(new Vector3(0, 2, -2), orientation), new Vector3(1, 2, 1), new Color(128, 255, 64, 100), false, false);
      _debugRenderer.DrawModel(_xnaModel, new Pose(new Vector3(0, 2, -2), orientation), new Vector3(1, 2, 1), Color.LightCyan, true, false);

...
LightNodes, CameraNodes, ...) and how to animate a skinned model.",
  ...
  public class SceneSample : Sample
  {
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      _model0.PoseWorld = new Pose(new Vector3(2, 0, 0))
                          * new Pose(Matrix.CreateRotationY(_angle))
                          * new Pose(new Vector3(2, 0, 0));
      _model1.PoseWorld = new Pose(new Vector3(-2, 0, 0))
                          * new Pose(Matrix.CreateRotationY(-_angle + 0.5f))
                          * new Pose(new Vector3(-2, 0, 0));

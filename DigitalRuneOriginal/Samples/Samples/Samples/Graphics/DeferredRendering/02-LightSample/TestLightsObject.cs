  ...
  public class TestLightsObject : GameObject
  {
    ...
    protected override void OnLoad()
    {
      ...
      })
      {
        ...
        PoseWorld = new Pose(new Vector3(0, 5, 0), Matrix.CreateRotationY(-1.4f) * Matrix.CreateRotationX(-0.6f)),
      ...
      })
      {
        ...
        PoseWorld = new Pose(new Vector3(0, 6, 0), Matrix.CreateRotationY(-1.4f) * Matrix.CreateRotationX(-0.6f) * Matrix.CreateRotationX(ConstantsF.Pi)),
      });
      ...
      {
        Name = "ProjectorLight",
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(-1, 1, -7), new Vector3(-5, 0, -7), new Vector3(0, 1, 0))).Inverse,
      });
      ...
      })
      {
        ...
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(5, 1, -7), new Vector3(1, 0, -7), new Vector3(0, 1, 0))).Inverse,
      ...
      {
        Name = "Spotlight",
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(-7, 1, -14), new Vector3(-10, 0, -14), new Vector3(0, 1, 0))).Inverse,
      });
      ...
      })
      {
        ...
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(-1, 1, -14), new Vector3(-5, 0, -14), new Vector3(0, 1, 0))).Inverse,
      });
      ...
      })
      {
        ...
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(5, 1, -14), new Vector3(1, 0, -14), new Vector3(0, 1, 0))).Inverse,
        Shadow = new StandardShadow
        {
          PreferredSize = 128,
        }
      ...
      })
      {
        ...
        PoseWorld = Pose.FromMatrix(Matrix.CreateLookAt(new Vector3(11, 1, -14), new Vector3(5, 0, -14), new Vector3(0, 1, 0))).Inverse,
        Shadow = new StandardShadow
        {
          PreferredSize = 128,
        }

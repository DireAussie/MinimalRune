...
namespace Samples.Animation
{
  ...
  public static class DudeRagdollCreator
  {
    ...
    public static void Create(SkeletonPose skeletonPose, Ragdoll ragdoll, Simulation simulation, float scale)
    {
      ...
      ragdoll.BodyOffsets[neck] = new Pose(new Vector3(0.15f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[armUpperLeft] = new Pose(new Vector3(0.2f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[armLowerLeft] = new Pose(new Vector3(0.2f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[armUpperRight] = new Pose(new Vector3(0.2f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[armLowerRight] = new Pose(new Vector3(0.2f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[legUpperLeft] = new Pose(new Vector3(0.4f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[legLowerLeft] = new Pose(new Vector3(0.32f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[legUpperRight] = new Pose(new Vector3(0.4f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      ragdoll.BodyOffsets[legLowerRight] = new Pose(new Vector3(0.32f * scale, 0, 0), Quaternion.CreateRotationZ(ConstantsF.PiOver2));
      ...
      AddTwistSwingLimit(ragdoll, neck, head, Matrix.Identity, Matrix.Identity, new Vector3(-0.1f, -0.5f, -0.7f), new Vector3(0.1f, 0.5f, 0.7f));
      ...
      AddTwistSwingLimit(ragdoll, backUpper, armUpperLeft, bindPoseRelative.Orientation * Matrix.CreateRotationY(-0.5f) * Matrix.CreateRotationZ(-0.5f), Matrix.Identity, new Vector3(-0.7f, -1.2f, -1.2f), new Vector3(0.7f, 1.2f, 1.2f));

      AddTwistSwingLimit(ragdoll, armUpperLeft, armLowerLeft, Matrix.CreateRotationZ(-1.2f), Matrix.Identity, new Vector3(-0.3f, -1.2f, -1.2f), new Vector3(0.3f, 1.2f, 1.2f));
      AddTwistSwingLimit(ragdoll, armLowerLeft, handLeft, Matrix.Identity, Matrix.CreateRotationX(+ConstantsF.PiOver2), new Vector3(-0.3f, -0.7f, -0.7f), new Vector3(0.3f, 0.7f, 0.7f));
      ...
      AddTwistSwingLimit(ragdoll, backUpper, armUpperRight, bindPoseRelative.Orientation * Matrix.CreateRotationY(0.5f) * Matrix.CreateRotationZ(-0.5f), Matrix.Identity, new Vector3(-0.7f, -1.2f, -1.2f), new Vector3(0.7f, 1.2f, 1.2f));

      AddTwistSwingLimit(ragdoll, armUpperRight, armLowerRight, Matrix.CreateRotationZ(-1.2f), Matrix.Identity, new Vector3(-0.3f, -1.2f, -1.2f), new Vector3(0.3f, 1.2f, 1.2f));
      AddTwistSwingLimit(ragdoll, armLowerRight, handRight, Matrix.Identity, Matrix.CreateRotationX(-ConstantsF.PiOver2), new Vector3(-0.3f, -0.7f, -0.7f), new Vector3(0.3f, 0.7f, 0.7f));
      ...
      bindPoseRelative = parentBindPoseAbsolute.Inverse * childBindPoseAbsolute;
      AddTwistSwingLimit(ragdoll, pelvis, legUpperLeft, bindPoseRelative.Orientation * Matrix.CreateRotationZ(1.2f), Matrix.Identity, new Vector3(-0.1f, -0.7f, -1.5f), new Vector3(+0.1f, +0.7f, +1.5f));

      AddAngularLimit(skeletonPose, ragdoll, legUpperLeft, legLowerLeft, new Vector3(0, 0, -2.2f), new Vector3(0, 0, 0.0f));
      AddTwistSwingLimit(ragdoll, legLowerLeft, footLeft, Matrix.Identity, Matrix.Identity, new Vector3(-0.1f, -0.3f, -0.7f), new Vector3(0.1f, 0.3f, 0.7f));

      parentBindPoseAbsolute = (Pose)skeleton.GetBindPoseAbsoluteInverse(pelvis).Inverse;
      childBindPoseAbsolute = (Pose)skeleton.GetBindPoseAbsoluteInverse(legUpperRight).Inverse;
      bindPoseRelative = parentBindPoseAbsolute.Inverse * childBindPoseAbsolute;
      AddTwistSwingLimit(ragdoll, pelvis, legUpperRight, bindPoseRelative.Orientation * Matrix.CreateRotationZ(1.2f), Matrix.Identity, new Vector3(-0.1f, -0.7f, -1.5f), new Vector3(+0.1f, +0.7f, +1.5f));

      AddAngularLimit(skeletonPose, ragdoll, legUpperRight, legLowerRight, new Vector3(0, 0, -2.2f), new Vector3(0, 0, 0.0f));
      AddTwistSwingLimit(ragdoll, legLowerRight, footRight, Matrix.Identity, Matrix.Identity, new Vector3(-0.1f, -0.3f, -0.7f), new Vector3(0.1f, 0.3f, 0.7f));
    ...
    private static void AddTwistSwingLimit(Ragdoll ragdoll, int parent, int child, Matrix parentAnchorOrientationLocal, Matrix childAnchorOrientationLocal, Vector3 minimum, Vector3 maximum)
    {
      var childBody = ragdoll.Bodies[child];
      var childOffset = ragdoll.BodyOffsets[child];
      var parentBody = ragdoll.Bodies[parent];

...
namespace Samples.Physics.Specialized
{
  ...
  public class CharacterControllerLevelObject : GameObject
  {
    ...
    protected override void OnLoad()
    {
      ...
      AddBody(simulation, "House2", new Pose(new Vector3(10, 2, -15), Matrix.CreateRotationY(-0.3f)), new BoxShape(8, 4, 2), MotionType.Static);
      ...
      AddBody(simulation, "V0", new Pose(new Vector3(-5.5f, 0, 10), Quaternion.CreateRotationZ(0.2f)), new BoxShape(1f, 2f, 2), MotionType.Static);
      AddBody(simulation, "V1", new Pose(new Vector3(-4, 0, 10), Quaternion.CreateRotationZ(-0.2f)), new BoxShape(1f, 2f, 2), MotionType.Static);
      ...
      // ceiling.
      AddBody(simulation, "SlopeGround", new Pose(new Vector3(-2, 1.8f, -12), Quaternion.CreateRotationX(0.4f)), new BoxShape(2, 0.5f, 10), MotionType.Static);
      AddBody(simulation, "SlopeRoof", new Pose(new Vector3(-2, 5.6f, -12), Quaternion.CreateRotationX(-0.4f)), new BoxShape(2, 0.5f, 10), MotionType.Static);
      ...
      // the wall.)
      AddBody(simulation, "LongSlope", new Pose(new Vector3(-24, 3, -10), Matrix.CreateRotationX(0.4f)), new BoxShape(4, 5f, 30), MotionType.Static);

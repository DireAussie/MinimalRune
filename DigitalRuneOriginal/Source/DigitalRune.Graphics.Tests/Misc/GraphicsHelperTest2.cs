...
namespace DigitalRune.Graphics.Tests
{
  ...
  public class GraphicsHelperTest2
  {
    ...
    public void ProjectTest()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(320, 240, 0), viewport.Project(new Vector3(0, 0, -10), projection, view)));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0, 0), viewport.Project(new Vector3(projection.Left, projection.Top, -10), projection, view)));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(640, 0, 0), viewport.Project(new Vector3(projection.Right, projection.Top, -10), projection, view)));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 480, 0), viewport.Project(new Vector3(projection.Left, projection.Bottom, -10), projection, view)));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(640, 480, 0), viewport.Project(new Vector3(projection.Right, projection.Bottom, -10), projection, view)));

      Vector3[] farCorners = new Vector3[4];
      GraphicsHelper.GetFrustumFarCorners(projection, farCorners);
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(320, 240, 1), viewport.Project(new Vector3(0, 0, -1000), projection, view)));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0, 1), viewport.Project((Vector3)farCorners[0], projection, view), 1e-4f));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(640, 0, 1), viewport.Project((Vector3)farCorners[1], projection, view), 1e-4f));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 480, 1), viewport.Project((Vector3)farCorners[2], projection, view), 1e-4f));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(640, 480, 1), viewport.Project((Vector3)farCorners[3], projection, view), 1e-4f));
    }

...
namespace MinimalRune.Graphics.Tests
{
  ...
  public class OcclusionCullingTest
  {
    ...
    public void GetBoundsOrthographic()
    {
      ...
      Matrix proj = Matrix.CreateOrthographic(16, 9, -10, 100);
    ...
    private void GetBoundsOrtho(Aabb aabbWorld, Matrix viewProj, out Aabb aabbClip)
    {
    ...
    private void GetBoundsOrthoSmart(Aabb aabbWorld, Matrix viewProj, out Aabb aabbClip)
    {
      Vector3 minimum = aabbWorld.Minimum;
      Vector3 maximum = aabbWorld.Maximum;
    ...
    public void GetBoundsPerspective()
    {
      ...
      Matrix view = Matrix.CreateLookAt(cameraPosition, cameraPosition + cameraForward, cameraUp);
      Matrix proj = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(90), 16.0f / 9.0f, 1, 100);
      Matrix viewProj = proj * view;
    ...
    private void GetBoundsPersp(Aabb aabbWorld, Matrix viewProj, out Aabb aabbClip)
    {
      Vector3 minimum = aabbWorld.Minimum;
      Vector3 maximum = aabbWorld.Maximum;
    ...
    private void GetBoundsPerspSmart(Aabb aabbWorld, Matrix viewProj, out Aabb aabbClip)
    {
      Vector3 minimum = aabbWorld.Minimum;
      Vector3 maximum = aabbWorld.Maximum;
      Vector3 extent = maximum - minimum;

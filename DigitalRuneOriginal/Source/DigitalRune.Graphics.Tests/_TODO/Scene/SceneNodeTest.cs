...
namespace DigitalRune.Graphics.Tests
{
  ...
  public class SceneNodeTest
  {
    ...
    {
      DummySceneNode nodeA = new DummySceneNode { PoseLocal = new Pose(new Vector3(1, 1, 1)) };
      DummySceneNode nodeB = new DummySceneNode { PoseLocal = new Pose(new Vector3(1, 2, -3)) };
      DummySceneNode nodeC = new DummySceneNode { PoseLocal = new Pose(new Vector3(1, 2, 3)) };
      DummySceneNode nodeD = new DummySceneNode { PoseLocal = new Pose(new Vector3(0, 0, -1)) };
      nodeA.Children.Add(nodeB);
      nodeA.Children.Add(nodeC);
      nodeB.Children.Add(nodeD);

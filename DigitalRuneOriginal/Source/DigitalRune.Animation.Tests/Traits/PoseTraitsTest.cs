...
//    {
//      return Vector3.AreNumericallyEqual(expected.Position, actual.Position)
//             && Matrix.AreNumericallyEqual(expected.Orientation, actual.Orientation);
//    }
...
//      var value = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());
...
//      var traits = PoseTraits.Instance;
//      var from = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());
//      var by = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());
...
//      var traits = PoseTraits.Instance;
//      var first = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());    // Animation value of first key frame.
//      var last = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());     // Animation value of last key frame.
...
//    {
//      var traits = PoseTraits.Instance;
//      var value0 = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());
//      var value1 = new Pose(_random.NextVector3(-100, 100), _random.NextQuaternion());

...
namespace MinimalRune.Animation.Tests
{
  ...
  public class AnimationHelperTest
  {
    ...
    public void ComputeLinearVelocity()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(v, AnimationHelper.ComputeLinearVelocity(p, targetPosition, dt)));
    }
    ...
    public void ComputeAngularVelocity()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(v, AnimationHelper.ComputeAngularVelocity(o0, o1, dt), 0.01f));
      Assert.IsTrue(Vector3.AreNumericallyEqual(v, AnimationHelper.ComputeAngularVelocity(o0.ToRotationMatrix33(), o1.ToRotationMatrix33(), dt), 0.01f));
    ...
    public void CompressEmptySrtKeyFrameAnimation2()
    {
      ...
      var srtKeyFrameAnimation = new SrtKeyFrameAnimation();
      var time = TimeSpan.FromTicks(100000);
      var value = new SrtTransform(random.NextVector3(-2, 2), random.NextQuaternion(), random.NextVector3(-10, 10));
    ...
    public void CompressEmptySrtKeyFrameAnimation4()
    {
      ...
      var srtKeyFrameAnimation = new SrtKeyFrameAnimation();
      var time0 = TimeSpan.FromTicks(100000);
      var value0 = new SrtTransform(random.NextVector3(-2, 2), random.NextQuaternion(), random.NextVector3(-10, 10));

      var time1 = TimeSpan.FromTicks(200000);
      var value1 = new SrtTransform(random.NextVector3(-2, 2), random.NextQuaternion(), random.NextVector3(-10, 10));
    ...
    public void CompressSrtKeyFrameAnimation()
    {
      ...
      var time0 = TimeSpan.FromTicks(100000);
      var value0 = new SrtTransform(Vector3.One, Quaternion.Identity, Vector3.Zero);

      var time1 = TimeSpan.FromTicks(200000);
      var value1 = new SrtTransform(new Vector3(2, 2, 2), Quaternion.CreateRotationX(MathHelper.ToRadians(10)), new Vector3(1, 1, 1));

      var time2 = TimeSpan.FromTicks(400000);
      var value2 = new SrtTransform(new Vector3(-1, -1, -1), Quaternion.CreateRotationX(MathHelper.ToRadians(80)), new Vector3(10, 10, 10));

      var time3 = TimeSpan.FromTicks(500000);
      var value3 = new SrtTransform(new Vector3(3, 3, 3), Quaternion.CreateRotationX(MathHelper.ToRadians(-10)), new Vector3(-2, -2, -2));
      ...
      Assert.AreEqual(4, ((KeyFrameAnimation<Quaternion>)srtAnimation.Rotation).KeyFrames.Count);
      ...
      for (int i = 0; i < numberOfSamples; i++)
      {
        ...
        Assert.IsTrue(Quaternion.GetAngle(valueRef.Rotation, valueNew.Rotation) <= MathHelper.ToRadians(rotationThreshold));
      ...
      Assert.AreEqual(srtKeyFrameAnimation.KeyFrames.Count, ((KeyFrameAnimation<Quaternion>)srtAnimation.Rotation).KeyFrames.Count);

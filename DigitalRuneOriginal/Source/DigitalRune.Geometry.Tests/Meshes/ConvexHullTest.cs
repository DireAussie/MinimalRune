...
namespace MinimalRune.Geometry.Meshes.Tests
{
  [TestFixture]
  public class ConvexHullTest
  {
    ...
    public void EmptyConvexHull()
    {
      ...
      //Assert.AreEqual(null, ConvexHullHelper.CreateConvexHullNew(new List<Vector3>()));
      Assert.AreEqual(null, GeometryHelper.CreateConvexHull(new List<Vector3>()));
    }
    ...
    {
      var points = new[] { new Vector3(1, 2, 3) };
      ...
      points = new[] { new Vector3(1, 2, 3), new Vector3(1, 2, 3), };
      ...
      points = new[]
      {
        new Vector3(1, 2, 3), 
        new Vector3(1, 2, 3), 
        new Vector3(1.000001f, 2, 3),
        new Vector3(1.000001f, 1.999999f, 3),
        new Vector3(1.000001f, 2, 3.000001f),
      };
      mesh = GeometryHelper.CreateConvexHull(points);
      Assert.AreEqual(1, mesh.Vertices.Count);
      //Assert.AreEqual(points[0], mesh.Vertex.Position);
    ...
    {
      var start = new Vector3(1, 10, 20);
      var end = new Vector3(10, 10, 20);
      ...
      points = new[] { start, end, start, end, start, new Vector3(1.00001f, 10.00001f, 20.00001f),  };
      mesh = GeometryHelper.CreateConvexHull(points);
      Assert.AreEqual(2, mesh.Vertices.Count);
      Assert.IsTrue(mesh.Vertices.Any(v => v.Position == start));
      Assert.IsTrue(mesh.Vertices.Any(v => v.Position == end));
      ...
      points = new[] { new Vector3(2, 10, 20), new Vector3(9.00001f, 10, 20), start, end, start };
      mesh = GeometryHelper.CreateConvexHull(points);
      Assert.AreEqual(2, mesh.Vertices.Count);
      Assert.IsTrue(mesh.Vertices.Any(v => v.Position == start));
      Assert.IsTrue(mesh.Vertices.Any(v => v.Position == end));
    ...
    {
      var a = new Vector3(1, 10, 20);
      var b = new Vector3(10, 10, 20);
      var c = new Vector3(10, 20, 20);
      var d = new Vector3(1, 20, 20);
      ...
      points = new[]
      {
        new Vector3(2, 10.1f, 20), 
        new Vector3(4, 13, 20), 
        new Vector3(2, 10.1f, 20), 
        a,
        new Vector3(2, 15, 20), 
        new Vector3(1.000001f, 10f, 20.000001f), 
        new Vector3(2, 10.1f, 20), 
        new Vector3(9, 17, 20), 
        a, 
        b, 
    ...
    public void SpatialConvexHull()
    {
      ...
      var d = new Vector3(10, 20, 0);
      var e = new Vector3(11, 21, 4);
    ...
    public void CreateConvexHull1()
    {
      ...
      mesh = GeometryHelper.CreateConvexHull(new[] { new Vector3(0, 0, 0), 
                                                       new Vector3(0, 0, 0),
                                                       new Vector3(1, 0, 0), 
                                                       new Vector3(1, 1, 0),
                                                       new Vector3(0, 0, 1),
    ...
    public void RandomPoints()
    {
      ...
      {
        points.Add(RandomHelper.Random.NextVector3(100, 300));
      }

...
namespace DigitalRune.Geometry.Shapes.Tests
{
  ...
  public class MinkowskiDifferenceShapeTest
  {
    ...
    public void SetUp()
    {
      ...
      cs.ObjectA = new GeometricObject(new CircleShape(3), new Pose(new Vector3(1, 0, 0), Quaternion.CreateRotationX(ConstantsF.PiOver2)));
    ...
    public void Constructor()
    {
      ...
      var m = new MinkowskiDifferenceShape(
        new GeometricObject(new CircleShape(3), new Pose(new Vector3(1, 0, 0), Quaternion.CreateRotationX(ConstantsF.PiOver2))),
    ...
    public void PropertiesTest()
    {
      ...
      Assert.AreEqual(new Pose(new Vector3(1, 0, 0), Quaternion.CreateRotationX(ConstantsF.PiOver2)), cs.ObjectA.Pose);
    ...
    public void GetSupportPoint()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(4, 5, 0), cs.GetSupportPoint(new Vector3(1, 0, 0))));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(4, 5, 0), cs.GetSupportPoint(new Vector3(0, 1, 0))));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(1, 5, 3), cs.GetSupportPoint(new Vector3(0, 0, 1))));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(-2, 5, 0), cs.GetSupportPoint(new Vector3(-1, 0, 0))));
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(4, -5, 0), cs.GetSupportPoint(new Vector3(0, -1, 0))));

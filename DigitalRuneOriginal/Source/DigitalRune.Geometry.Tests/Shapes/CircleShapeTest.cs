...
namespace MinimalRune.Geometry.Shapes.Tests
{
  ...
  public class CircleTest
  {
    ...
    //  Assert.IsTrue(Numeric.AreEqual(Vector3.ProjectTo(new Vector3(-10, 0, 0), new Vector3(-1, 0, -1)).Length, new CircleShape(10).GetSupportPointDistance(new Vector3(-1, 0, -1))));
    //  Assert.IsTrue(Numeric.AreEqual(Vector3.ProjectTo(10*new Vector3(1, 1, 0).Normalized, new Vector3(1, 1, 1)).Length, new CircleShape(10).GetSupportPointDistance(new Vector3(1, 1, 1))));
    //}

...
namespace MinimalRune.Geometry.Shapes.Tests
{
  ...
  public class LineSegmentShapeTest
  {
    ...
    //  Assert.IsTrue(Numeric.AreEqual(-Vector3.ProjectTo(new Vector3(1, 2, 3), new Vector3(-1, 0, -1)).Length, new LineSegment(new Vector3(1, 2, 3), new Vector3(4, 5, 6)).GetSupportPointDistance(new Vector3(-1, 0, -1))));
    //  Assert.IsTrue(Numeric.AreEqual(Vector3.ProjectTo(new Vector3(4, 5, 6), new Vector3(1, 1, 1)).Length, new LineSegment(new Vector3(1, 2, 3), new Vector3(4, 5, 6)).GetSupportPointDistance(new Vector3(1, 1, 1))));
    //}

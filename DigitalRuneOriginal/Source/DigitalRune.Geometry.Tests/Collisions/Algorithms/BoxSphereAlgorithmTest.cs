...
namespace DigitalRune.Geometry.Collisions.Algorithms.Tests
{
  ...
  public class BoxSphereAlgorithmTest
  {
    ...
    public void TestSphereCenterInBox()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0.35f, 0, 0), algo.GetContacts(a, b)[0].Position));
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0.85f, 0), algo.GetContacts(a, b)[0].Position));
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0, 1.35f), algo.GetContacts(a, b)[0].Position));
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0, -1.35f), algo.GetContacts(b, a)[0].Position));
    }
    ...
    public void TestSphereOnSurface()
    {
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0.4f, 0, 0f), algo.GetContacts(a, b)[0].Position));
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0.0f, 0.9f, 0f), algo.GetContacts(a, b)[0].Position));
      ...
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0, 0, 1.4f), algo.GetContacts(a, b)[0].Position));

      ((GeometricObject)a.GeometricObject).Pose = new Pose(new Vector3(0, 0, 0));
      ((GeometricObject)b.GeometricObject).Pose = new Pose(new Vector3(-0.5f, -1, -1.5f));
      Assert.AreEqual(1, algo.GetContacts(a, b).Count);
      Assert.AreEqual(new Vector3(-1, 0, 0).Normalized, algo.GetContacts(a, b)[0].Normal);
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(-0.4f, -1, -1.5f), algo.GetContacts(a, b)[0].Position));

      ((GeometricObject)a.GeometricObject).Pose = new Pose(new Vector3(0, 0, 0));
      ((GeometricObject)b.GeometricObject).Pose = new Pose(new Vector3(0f, -1, 1.5f));
      Assert.AreEqual(1, algo.GetContacts(a, b).Count);
      Assert.AreEqual(new Vector3(0, -1, 0).Normalized, algo.GetContacts(a, b)[0].Normal);
      Assert.IsTrue(Vector3.AreNumericallyEqual(new Vector3(0.0f, -0.9f, 1.5f), algo.GetContacts(a, b)[0].Position));

...
namespace MinimalRune.Geometry.Collisions.Algorithms.Tests
{
  ...
  public class RayTriangleAlgorithmTest
  {
    ...
    public void ComputeCollision()
    {
      ...
      // Touching
      ((GeometricObject)ray.GeometricObject).Pose = new Pose(new Vector3(5, 0, 0));
      ...
      ((GeometricObject)ray.GeometricObject).Pose = new Pose(new Vector3(4, 0.1f, 0.1f));
      ...
      ((GeometricObject)ray.GeometricObject).Pose = new Pose(new Vector3(5, 1.1f, 0.1f));
      algo.UpdateContacts(set, 0);
    ...
    public void DegenerateTriangle()
    {
      ...
      ((GeometricObject)ray.GeometricObject).Shape = new RayShape(new Vector3(0, 0, 0), new Vector3(-1, 0, 0), 10);
      ((GeometricObject)ray.GeometricObject).Pose = new Pose(new Vector3(11, 0, 0));

      CollisionObject triangle = new CollisionObject();
      ((GeometricObject)triangle.GeometricObject).Shape = new TriangleShape(new Vector3(0, 0, 0), new Vector3(0, 1, 0), new Vector3(0, 1, 0));  // 2 identical vertices.
      ((GeometricObject)triangle.GeometricObject).Pose = new Pose(new Vector3(0, 0, 0));
